...
const ROOM_MATERIAL_ANALYSIS_PROMPT = [
  ...
  "세대 주 출입문 바깥쪽의 공용 복도, 계단실, 엘리베이터 홀, 공동 현관 전실은 COMMON_AREA로 분류하세요.",
  "COMMON_AREA polygon은 현관문 바깥쪽 실제 통행 바닥만 포함하고 세대 내부 ENTRY, 거실, 주방과 겹치지 않게 하세요.",
  "공용공간과 세대 내부를 확실히 구분할 수 없으면 COMMON_AREA를 반환하지 마세요. UNKNOWN이나 다른 실내 공간을 COMMON_AREA로 바꾸지 마세요.",
  "도면 바깥 여백, 치수선 영역, 건물 외부 배경은 COMMON_AREA가 아닙니다.",
