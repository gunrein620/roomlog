...
// M-HOME-05(건물·호실 등록 / CSV) 데모 콘텐츠를 00 페이지 하단 섹션으로 통합.
// 상단 탭 "건물·호실 등록"은 /manager/home/00#register로 스크롤한다.
export function RegisterSection() {
  return (
    <section id="register" aria-labelledby="register-section-title" className="manager-embedded-section">
      <div className="manager-embedded-section-heading">
        <h2 id="register-section-title">건물·호실 등록</h2>
