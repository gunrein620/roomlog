...
export class RoomlogService {
  ...
  private buildRealtimeInstructions(
    ...
    return [
      ...
      "- 증상, 위치, 발생 시점, 위험 여부, 사진 유무, 방문 가능 시간을 자연스럽게 확인합니다.",
      "- 누수, 가스, 누전, 문 잠김 실패, 침수처럼 안전 위험이 있으면 긴급으로 분류하고 즉시 관리자 확인을 안내합니다.",
      "- 책임 소재를 확정하지 말고 가능성만 말합니다. 법적 판단이나 비용 부담 확정 표현은 피합니다.",
      "- 마지막에는 접수 초안에 들어갈 제목, 요약, 위치, 긴급도, 추가 필요 정보를 간결히 정리합니다.",
