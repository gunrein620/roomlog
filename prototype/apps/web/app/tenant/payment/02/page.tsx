...
import { createReport, DEMO_BILL_ID } from "@/lib/payment-api";
import { PAYMENT_ROUTES } from "@/lib/payment-nav";
import { DEMO_BILL } from "@/lib/demo-payment";

// T-PAY-02 · 납부 신고
// 이체 안내 + 납부 신고(자기신고 ≠ 실제 입금 확정). 신고 → 인-스크린 '확인 중'·ETA → 홈(00).
// 원칙: 자기신고 큐로 유입(확인 전 집계 제외). 입금자명이 본인과 다르면 기입(orphan 매칭 보조).
...
export default function Page() {
  ...
  const submitReport = async () => {
    ...
    await createReport(DEMO_BILL_ID, {
